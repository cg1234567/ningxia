<template>
  <div id="govCloud">
    ...
    <div class="zwytitle">平罗县人口基础信息</div>
    <div class="content">
      <div class="left">
        <div class="item">
...
export default {
  ...
  methods: {
    rkjztinit() {
      ...
      let dataarr = [
        { value: 62836, name: '0~17岁' },
        { value: 75430, name: '18~34岁' },
        { value: 121075, name: '35~60岁' },
        { value: 51651, name: '60岁以上' }
      ]
      let option = {
        tooltip: {
          trigger: 'item',
    ...
    ssmzinit() {
      ...
      let option = {
        ...
        series: [{
          ...
          radius: ['50%', '75%'],
          data: [
            { value: 112057, name: '回族' },
            { value: 178365, name: '汉族' },
            { value: 786, name: '其他民族' },
          ],
          label: {
            color: '#ddd',
    ...
    xzrkinit() {
      ...
      let option = {
        ...
        xAxis: {
          ...
          data: ['城关镇', '黄渠桥镇','宝丰镇','头闸镇','姚伏镇','崇岗镇','陶乐镇','高庄乡','灵沙乡','渠口乡','通伏乡','高仁乡','红崖子乡'],
          boundaryGap: [0, 0.01]
        },
        yAxis: {
          type: 'value',
        ...
        series: [{
            name: '各乡镇人口',
            type: 'bar',
            data: [72082,25558,17738,19821,31255,13280,16232,23631,20961,23073,21819,7510,18029]
          },
        ]
      };
