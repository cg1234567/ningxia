...
export default {
  ...
  data() {
    return {
      isvideo: false,
      sslklist:[
        {state:'严重拥堵',area:'团结西路',num:'3.2',type:2},
        {state:'拥堵',area:'民族大街与金桥路西',num:'2.0',type:1},
        {state:'畅通',area:'康乐路向东段',num:'1.0',type:0},
        {state:'畅通',area:'人民东路段',num:'1.0',type:0},
      ],
      midtoplist: [
      ...
      shequlist: [{
          ...
          message: {
            ...
            intro: '2019年12月2日至2020年6月25日，对民族大街与金桥路西北交汇处路段进行道路交通全封闭施工'
          },
        },
        {
          name: '道路维护',
          longitude: '106.678235',
          latitude: '38.937588',
          sel: false,
          type:1,
          message: {
            name: '道路维护',
            img: require('@/assets/image/sg.png'),
            intro: '2020年2月12日至2020年5月25日，对头闸镇平头公路加油站西侧附近进行道路交通全封闭施工'
          },
        },
        {
          name: '道路维护',
          longitude: '106.566545',
          latitude: '38.91504',
          sel: false,
          type:2,
          message: {
            name: '道路维护',
            img: require('@/assets/image/sg.png'),
            intro: '2020年4月1日至2020年6月30日，对唐徕大街与团结东路交叉口进行道路交通全封闭施工'
          },
        },
      ]
    }
