...
export default {
    ...
    return {
      ...
      detailtest: {
        平罗县人民医院: {
          ...
          content: '平罗县人民医院是一家综合性的二级甲等医院，每年接待患者数量位居石嘴山市境内各医疗机构前列，医方十分注重采用先进的医疗设备技术为患者提供准确的疗理诊断，在设备的采购上也十分注重公开、透明'
        },
        平罗县中医院: {
          img: require('../../assets/img/h2.png'),
          content: '平罗县中医院自建院以来，一直以诚信立院为本，突出诊疗综合实力，现在平罗县中医院在院长何宝孝的带领下，不断加强人才兴院、技术兴院、服务兴院;大量引进先进设备，紧密跟进医疗科学前沿技术，积极培育优势学科群体。平罗县中医院逐步形成以男科，妇科，妇产科，性病科，皮肤科，肛肠科，肝病科，五官科，骨科，泌尿科，眼科，神经科，耳鼻喉科，胃肠科等为特色的专项疾病诊疗中心，平罗县中医院在地区率先成立了相关疾病专项实验中心，对各类常见病、多发病及疑难杂症进行监控、研究。平罗县中医院在其他的同等级医院里，对疾病的防治的先进性和前瞻性具有重要的战略意义'
        },
        平罗县妇幼保健院: {
          img: require('../../assets/img/h3.png'),
          content: '平罗县妇幼保健院位于宁夏回族自治区石嘴山市平罗县民族大街，设置保健部及六个专业保健科室，全面负责全区妇幼保健业务的管理与指导，以群众妇幼保健需求为导向，积极探索并不断创新妇幼保健管理服务模式，对辖区各级医疗保健机构、各地段保健机构及社区卫生服务机构的妇幼卫生工作实行“一体化”管理'
        }
      }
    }
  },
  ...
  methods: {
    ...
    mapMarker (map) {
      ...
      map.setFitView()
      map.setZoom(11)
      map.setCenter([106.548591, 38.919157])
    },
    // 搜索
    siteSearch () {
      var ws = 0
