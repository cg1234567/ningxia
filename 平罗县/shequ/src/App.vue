...
export default {
  ...
  data () {
    return {
      ...
      midtoplist:[
        {num:218,name:'小区总数（个）'},
        {num:316000,name:'常住人口（人）'},
        {num:290422,name:'总人数（人）'},
      ],
      ...
      shequlist:[
        {
          name:'星海花园',longitude:'106.54234',latitude:'38.913218',sel:false,
          message:{
            name:'星海花园',
            img:require('@/assets/image/xhhy.png'),
            list:[
              {
                img:require('@/assets/image/ry.png'),
                lable:'人员：',
            ...
            intro:'星海花园由新业房地产开发有限公司开发,位于宁夏石嘴山惠农区,楼盘类型有公寓,建筑形式,星海花园地址位于星海湖' },
          area:[
        ...
        {
          name:'阳光城市花园',longitude:'106.535979',latitude:'38.910105',sel:false,
          message:{
            name:'阳光城市花园',
            ...
            intro:'此小区地理位置优越，环境优美，交通便利，周边设施完善' },
            area:[
        ...
        {
          name:'世纪家园',longitude:'106.556772',latitude:'38.917752',sel:false,
          message:{
            name:'世纪家园',
            ...
            intro:'此小区管理严格服务到家让你生活放心，小区绿化率高，安静舒适让你居住的同时能够享受品质生活，紧邻商业街、交通方便' },
            area:[
                [106.292949,36.00956],
