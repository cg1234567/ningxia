      ...
      shequlist: [
        {
          ...
          message: {
            name: '宁夏中卫中学',
            img: require('@/assets/image/zwzx.png'),
            intro: '中卫中学创建于1932年，是自治区首批重点中学、区级示范性高级中学、全国五百所著名中学。金日成主席的老师尚钺、自治区领导雷启霖、纳长其、吴尚贤等曾在此执教，原全国人大、政协领导钱伟长、雷洁琼、彭佩云等为学校题写校名、校训、纪念碑文'
          },
        },
        {
          name: '中卫市第一中学',
          longitude: '105.215488',
          latitude: '37.513927',
          sel: false,
          message: {
            name: '中卫市第一中学',
            img: require('@/assets/image/zw1.png'),
            intro: '中卫市第一中学位于宁夏回族自治区中卫市东大街文萃南路。1984年由原官桥小学改建，2006年5月迁入现在的校址。2017年11月，中卫市第一中学获评第一届全国文明校园'
          },
        },
        {
          name: '中宁县第一中学',
          longitude: '105.691201',
          latitude: '37.505423',
          sel: false,
          message: {
            name: '中宁县第一中学',
            img: require('@/assets/image/gy8.png'),
            intro: '中宁县第一中学兴建于2004年，2005年9月正式投入使用，实现首批高一招生，并接受中宁二中高二、高三年级学生。2016在校学生数3874人，教职工数240名。校址位于中宁县裕民东街'
          },
        },
      ]
    }
