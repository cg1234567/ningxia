...
export default {
  ...
  data() {
    return {
      isvideo: false,
      sslklist:[
        {state:'严重拥堵',area:'中央东大道',num:'3.2',type:2},
        {state:'拥堵',area:'中营高速公路北段',num:'2.0',type:1},
        {state:'畅通',area:'中央大道与迎闫公路交叉口',num:'1.0',type:0},
        {state:'畅通',area:'鼓楼东街',num:'1.0',type:0},
      ],
      midtoplist: [
      ...
      shequlist: [{
          ...
          message: {
            ...
            intro: '2019年12月2日至2020年6月25日，对中卫市沙坡头区鼓楼西街路段进行道路交通全封闭施工'
          },
        },
        {
          name: '道路维护',
          longitude: '105.213578',
          latitude: '37.495677',
          sel: false,
          type:1,
          message: {
            name: '道路维护',
            img: require('@/assets/image/sg.png'),
            intro: '2020年2月12日至2020年5月25日，对中卫市沙坡头区滨河首府(怀远南街东) 附近进行道路交通全封闭施工'
          },
        },
        {
          name: '道路维护',
          longitude: '105.221638',
          latitude: '37.501017',
          sel: false,
          type:2,
          message: {
            name: '道路维护',
            img: require('@/assets/image/sg.png'),
            intro: '2020年4月1日至2020年6月30日，对坡头区平安东路与迎宾大道交叉口东南150米进行道路交通全封闭施工'
          },
        },
      ]
    }
