<template>
  <div id="economy">
    ...
    <div class="zwytitle">中卫市宏观经济</div>
    <div class="content">
      <div class="left">
        <div class="item">
...
export default {
  ...
  data () {
    return {
      midlist:[
        {num:140129,name:'税收收入（亿元）'},
        {num:80419,name:'非税收收入（万元）'},
        {num:437.65,name:'GDP产值（亿元）'}],
      tclist:[
        {name:'沙坡头区',num1:148890,num2:1901200},
        {name:'中宁县',num1:105973,num2:1713557},
        {name:'海原县',num1:24642,num2:761705}
        ],
      tcindex:0,
      times:0,
      timertc:null,
  ...
  methods: {
    sczzinit() {
      ...
      let dataarr = [
                      {value: 803064.3, name: '农业'},
                      {value: 7129.1, name: '林业'},
                      {value: 344661.1, name: '畜牧业'},
                      {value: 28770.8, name: '渔业'},
                      {value: 38118.2, name: '服务业'},
                  ]
      let option = {
          ...
          series: [
            {
              ...
              type: "line",
              symbol: 'circle',
              data:[-32.5,-10.2,-7.0,-5.8,-17.0,-2.1,-6.2,-6.6,-1.5,2.4,5.1,4.7],
              lineStyle: {
                normal: {
                  width: 3,
                  color: "#F5A623",
    ...
    cyqkinit() {
      ...
      let dataarr = [
                      {value: 601842, name: '第一产业'},
                      {value: 1871113, name: '第二产业'},
                      {value: 1903508, name: '第三产业'}
                  ]
      let option = {
          color:['rgba(64, 136, 200, 1)','rgba(198, 92, 67, 1)','rgba(19, 216, 186, 1)','rgba(82, 169, 224, 1)'],
          tooltip: {
