...
export default {
  ...
  data () {
    return {
      ...
      midtoplist:[
        {num:303,name:'小区总数（个）'},
        {num:431133,name:'常住人口（人）'},
        {num:468258,name:'总人数（人）'},
      ],
      ...
      shequlist:[
        {
          name:'东海园区',longitude:'106.2788694800',latitude:'36.0194763100',sel:false,
          message:{
            name:'东海园区',
            img:require('@/assets/image/dhyq.png'),
            list:[
        ...
        {
          name:'万和家园',longitude:'106.2950469500',latitude:'36.0238664200',sel:false,
          message:{
            name:'万和家园',
            ...
            intro:'万和家园，是原州区的一个住宅小区，周边有学校、医院、银行、超市等配套。' },
            area:[
        ...
        {
          name:'原州府',longitude:'106.2979797700',latitude:'36.0096992100',sel:false,
          message:{
            name:'原州府',
            ...
            intro:'原州老街原州小区，位于人民街城隍庙旁，出门就有大型商业广场，小吃街。周边有体育广场，县医院。出行方便，街道繁华。周边学区广泛，有二幼，附小、三中等中学。' },
            area:[
                [106.292949,36.00956],
