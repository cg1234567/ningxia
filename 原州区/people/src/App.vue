<template>
  <div id="govCloud">
    ...
    <div class="zwytitle">原州区人口基础信息</div>
    <div class="content">
      <div class="left">
        <div class="item">
    ...
    ssmzinit() {
      ...
      let option = {
        ...
        series: [{
          ...
          radius: ['50%', '75%'],
          data: [
            { value: 228828, name: '回族' },
            { value: 238591, name: '汉族' },
            { value: 839, name: '其他民族' },
          ],
          label: {
            color: '#ddd',
    ...
    xzrkinit() {
      ...
      let option = {
        ...
        xAxis: {
          ...
          data: ['三营镇', '中河乡','北塬街道办事处','南关街道办事处','古雁街道办事处','头营镇','官厅镇','寨科乡','开城镇','张易镇','彭堡镇','河川乡','炭山乡','黄铎堡镇'],
          boundaryGap: [0, 0.01]
        },
        yAxis: {
          type: 'value',
        ...
        series: [{
            name: '各乡镇人口',
            type: 'bar',
            data: [37418,28773,43001,61161,45604,52649,20507,14751,29925,42054,32313,12670,13502,33930]
          },
        ]
      };
