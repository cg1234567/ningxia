<template>
  <div id="economy">
    ...
    <div class="zwytitle">固原市宏观经济</div>
    <div class="content">
      <div class="left">
        <div class="item">
...
export default {
  ...
  data () {
    return {
      midlist:[
        {num:102730,name:'税收收入（万元）'},
        {num:69870,name:'非税收收入（万元）'},
        {num:303.19,name:'GDP产值（亿元）'}],
      tclist:[
  ...
  methods: {
    ...
    cyqkinit() {
      ...
      let dataarr = [
                      {value: 19.1, name: '第一产业'},
                      {value: 27.9, name: '第二产业'},
                      {value: 53, name: '第三产业'}
                  ]
      let option = {
          color:['rgba(64, 136, 200, 1)','rgba(198, 92, 67, 1)','rgba(19, 216, 186, 1)','rgba(82, 169, 224, 1)'],
