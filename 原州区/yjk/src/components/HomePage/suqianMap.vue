...
export default {
    ...
    return {
      ...
      detailtest: {
        固原市人民医院: {
          ...
          content: '固原市人民医院又名宁夏回族自治区第二人民医院，创建于1958年，其前身为中国人民志愿军531医院，是一家集医疗、教学、科研、急救、保健为一体的三级乙等非营利性公立医院，承担着固原市四县一区及周边市县等地200多万群众的基本医疗救治工作，同时承担着宁夏医科大学、甘肃医学院等医学院校学生的实习和基层卫生院专业技术人员的进修培训任务，是宁夏医科大学附属医院、助理全科医师培训基地和宁南区域医疗服务中心。固原市人民医院占地207.5亩，总建筑面积12.68万平方米。包括门诊急诊楼、医技楼、儿科综合楼、传染病区、住院部等，规划总床位1000张。'
        },
        固原市原州区人民医院: {
          img: require('../../assets/img/h2.png'),
          content: '固原市原州区人民医院是集医疗、预防、保健、教学为一体的二级甲等综合性医院，医院占地面积2.6万平方米，建筑面积3.1万平方米。医院设有骨科、普外科、泌尿外科、妇科、产科、眼科、麻醉科、神经内科、心内科、呼吸内科、消化内科、儿科、新生儿科、感染科、中医科、康复科、急诊科、肾内科、重症监护室19个临床科室；放射室、检验科、CT室、B超室、心（脑）电图室、内窥镜室、病检室8个辅助科室及行政办公室、质控科、医教科、护理部、院感科、保健科、纠纷办、体检科、财务科、药械科、后勤科、保卫科12个职能科室。医院承担着全区及周边60余万群众医疗保健任务，年门诊接待17万人次，住院病人2.3万余人次。'
        },
        固原市妇幼保健院: {
          img: require('../../assets/img/h3.png'),
          content: '固原市妇幼保健计划生育服务中心始建于1975年，2010年7月份迁至现院，占地面积24058.40平方米（36.09亩），建筑面积10514平方米，编制病床230张，固定资产8000多万元。医院为副处级公共卫生事业单位。2013年批准成立固原市儿童医院。2015年2月与市计划生育服务中心整合，组建了固原市妇幼保健计划生育服务中心。2016年7月市区两级妇幼保健计划生育服务中心整合，实行一个机构、一套班子、一个制度、一个方案，四块牌子（固原市妇幼保健计划生育服务中心、固原市儿童医院、固原市妇幼保健院、原州区妇幼保健计划生育服务中心），实现了市、区妇幼保健计划生育服务中心资源共享、优势互补，有利于加强妇幼保健和计划生育技术服务工作，有利于发挥人才优势、技术优势、设备优势和资源优势。'
        },
        固原市中医医院: {
          img: require('../../assets/img/h4.png'),
          content: '固原市中医医院成立于1982年，是一所以中医临床和中医康复为重点建设方向，中西医并重，内外兼治，传统与现代诊疗技术相结合的二级甲等中医医院，是固原市中医药发展的主力军与主阵地，并承担着中医药科研、教学和群众康复任务。先后荣获“全区中医药先进集体”、固原市“文明单位”、“园林式单位”等荣誉称号，年门诊量已接近20万人次。 医院占地面积100亩，现使用建筑面积13098平方米，开设床位300张。现设有针灸科、骨伤科、外妇科、脑病科、内科、急诊科、治未病科、脾胃病科、眼科、口腔科、耳鼻喉科、放射科、功能科、检验科、手术室等17个医疗、医技科室。医院现有职工381人，其中卫生专业技术人员300人；高级职称61人，中级职称40人，固原市“六盘名医”9人。'
        }
      }
    }
  },
  ...
  methods: {
    ...
    mapMarker (map) {
      ...
      map.setFitView()
      map.setZoom(11)
      map.setCenter([106.28778199999999, 36.00374])
    },
    // 搜索
    siteSearch () {
      var ws = 0
    ...
    init (map) {
      map = new AMap.Map('suqianMap', {
        ...
        zooms: [3, 20],
        center: [106.28778199999999, 36.00374]
      })
